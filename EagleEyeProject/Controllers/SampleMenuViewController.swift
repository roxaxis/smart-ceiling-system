...
class SampleMenuViewController: MenuViewController, Storyboardable {
    ...
    override func viewDidLayoutSubviews() {
        ...
        let topColor = UIColor(red: 0.0/255.0, green: 0.0/255.0, blue: 0.0/255.0, alpha: 1.0)
        let bottomColor = UIColor(red: 0.0/255.0, green: 0.0/255.0, blue: 0.0/255.0, alpha: 1.0)
